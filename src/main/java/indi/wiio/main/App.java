...
//        primaryStage.show();
        ...
        fxmlLoader = new FXMLLoader(getClass().getResource("sar.fxml"));
        root = fxmlLoader.load();

        FXMLLoader fxmlLoader2 = new FXMLLoader(getClass().getResource("layouts/start/create_room_pane.fxml"));   //提前load，让监听器设置好
