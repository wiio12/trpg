...
public class ChatPane implements Initializable {
    ...
    public DialogPanel addChatTab(String tabName) {
        FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("dialog_panel.fxml"));
    ...
    public void handleSendR(){
        try {
            FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("player_dialog_right.fxml"));
    ...
    public void handleSendL(String fromUser, String msg){
        try {
            FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("player_dialog_left.fxml"));
