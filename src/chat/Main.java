...
import main.KpMainWindowPane;
import network.client.Client;
import network.client.ClientMain;
import network.server.ServerMain;
import start.CreateRoomPane;
import start.StartPane;
...
//        primaryStage.show();
        ...
        fxmlLoader = new FXMLLoader(getClass().getResource("/start/start_pane.fxml"));
        root = fxmlLoader.load();

        FXMLLoader fxmlLoader2 = new FXMLLoader(getClass().getResource("/start/create_room_pane.fxml"));   //提前load，让监听器设置好
...
//    }
    ...
    public static void setKpMainWindowPane(KpMainWindowPane kpMainWindowPane) {
        Main.kpMainWindowPane = kpMainWindowPane;
    }
}
